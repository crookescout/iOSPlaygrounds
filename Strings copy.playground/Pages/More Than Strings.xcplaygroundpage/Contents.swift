...
let object = "jacket"
let place = "store"
let positiveEmotion = "hopeful"
let negativeEmotion = "disappointed"
let randomStory = "Today was a big day for \(yourName). She had finally saved up \(yourMoney) dollars and was going to buy a \(adjective) \(object). She went to the \(object) \(place) feeling very \(positiveEmotion). But then she felt \(negativeEmotion). They were all out of \(object)s!"

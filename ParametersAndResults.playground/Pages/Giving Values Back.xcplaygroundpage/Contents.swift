...
let favoriteMovie = makeFavorite(categoryOfThing: "movie", favorite: "Interstellar")
let school = makeFavorite(categoryOfThing: "school subject", favorite: "science")
let favoriteFood = makeFavorite(categoryOfThing: "food", favorite: "fruit")
let song = makeFavorite(categoryOfThing: "song", favorite: "The Morning")
...
"Hello, my name is Scout. \(favoriteFood). \(favoriteMovie) ..."

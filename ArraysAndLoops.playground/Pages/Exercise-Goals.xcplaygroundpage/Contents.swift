...
*/
let milesRun = [1, 2, 1.5, 3, 1, 1.5, 2.5, 2, 3, 3.5, 1.5, 1, 0.5, 2, 1, 1.5, 2.5, 3, 1, 3.5, 2]
...
func goal(dailyNumber: Double){
    if dailyNumber >= 2{
        print("You ran pretty far today.")
    }else{
        print("Not too bad...")
    }
}
...
for miles in milesRun{
    goal(dailyNumber: miles)
}

...
var songs = [String]()
songs.append("DHL")
songs.append("The Morning")
songs.append("Bound 2")
songs.append("See You Again")
 ...
 */
songs += ["Feel No Ways", "3005", "Selfish"]
 ...
 */
for song in songs {
    print("Alright, let's welcome our next singer on to stage to sing \(song)!")
}

...
let totalTime = brushTeeth + chooseClothes + makeBreakfast + fixLunch + finishHomework
...
let thingsILike = brushTeeth + chooseClothes + makeBreakfast
let thingIDontLike = fixLunch + finishHomework

let theTotalTime = thingsILike + thingIDontLike
/*:

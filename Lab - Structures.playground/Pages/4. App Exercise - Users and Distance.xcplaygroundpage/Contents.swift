 ...
 */
var scout = User(name: "Scout", age: 17, height: 68, weight: 150, activityLevel: 9)
print("\(scout.name) is \(scout.age) years old, \(scout.height) inches tall, \(scout.weight) pounds, and has an activity level of \(scout.activityLevel) on a scale fro 1-10.")
...
var kilometer = Distance(feet:20000)

...
var favoriteBook = Book(title: "Environmental Science for AP", author: "Andrew Friedland and Rick Relyea", pages: 400, price: 50.00)
print("My favorite book is called \(favoriteBook.title), written by \(favoriteBook.author). This book has \(favoriteBook.pages) pages and costs about \(favoriteBook.price) dollars.")
/*:
